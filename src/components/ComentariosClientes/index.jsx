...
const ComentariosClientes = () => {
  return (
    <div className='col-12 row comentariosClientes'>
      ...
      <div className='clientesImgContainer row d-flex align-items-center justify-content-evenly'>
        <div className='firstRow d-flex flex-row align-items-center justify-content-evenly'>
        ...
        <div className='secondRow d-flex flex-row align-items-center justify-content-evenly'>

      ...
      <form className='form'>
        <div className='d-flex flex-column flex-lg-row justify-content-center align-content-center form'>
          <div className='inputs d-flex flex-column justify-content-between m-lg-4'>
            ...
            <input className='d-inline-block my-1 my-lg-0' type="email" placeholder='Tu e-mail' />
            <input className='d-inline-block my-1 my-lg-0' type="number" placeholder='Tu teléfono' />
          </div>
          <textarea className='consulta my-1 m-lg-4' placeholder='Contanos, ¿en qué podemos ayudarte?' cols="30" rows="10"></textarea>
        </div>

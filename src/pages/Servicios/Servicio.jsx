  ...
  return (
    <div className="serviciosContainer col-12 row">
      ...
      <div className='servicio col-12 row'>
        {imagen === 'l' && <img src={`/images/${servicios[servicio].image}`} alt={servicios[servicio].alt} className='servicioImg col-12 col-md-4'/>}        
        ...
        {imagen === 'r' && <img src={`/images/${servicios[servicio].image}`} alt={servicios[servicio].alt} className='servicioImg col-12 col-md-4'/>}
      </div>
